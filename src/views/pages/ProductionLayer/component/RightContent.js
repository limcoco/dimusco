                          ...
                          {members.map((value, index) => {
                            return (
                              <AssignedRow
                                key={index}
                                index={index}
                                data={{ data: value, type: "user", id: value.gid }}
